...
interface CreatePostModalTemplateProps {
    isOpen?: boolean;
    onClose: ()=> void;
    onSubmit: ()=> void;
    title?: string;
...
const CreatePostModalTemplate: React.FC<CreatePostModalTemplateProps> = ({paddingTop, isOpen, body, title, onClose, onSubmit, secondaryAction, secondaryActionLabel, actionlabel}) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto bg-opacity-60 outline-none no-scrollbar focus:outline-none backdrop-blurr-sm bg-black">
            <div className={`relative w-full h-full mx-auto my-6 transition md:w-4/6 lg:w-2/4 xl:w-[745px] lg:h-[590px] md:h-[590px]`}>
...
export default CreatePostModalTemplate